    ...
    extraConfig =
      ...
      concatStrings [
        ''
          ...
          exec-once = sleep 1.5 && swww img /home/${username}/Pictures/Wallpapers/manstreetnight.jpg
          exec-once = /home/tim/taezeasystems/config/appimage/stack.Appimage
          ...
          windowrulev2 = opacity 0.9 0.7, class:^(thunderbird)$
          windowrulev2 = opacity 0.9 0.7, class:^(microsoft-edge)$
          windowrulev2 = opacity 0.9 0.7, class:^(element-desktop)$ 
          windowrulev2 = opacity 0.9 0.7, class:^(teams-for-linux)$
